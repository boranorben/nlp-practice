...
void usage_kma()
{
	...
	puts("usage: kma [-options] [input.txt] [output.txt]\n");
...
void morph_out_test(fp, out1, out2, mode)
FILE *fp;
HAM_PMORES out1;
HAM_PMORES2 out2;
HAM_PRUNMODE mode;
...
HAM_RUNMODE mode;
{
	...
	fprintf(stderr, "you should modify <src/kma.c> and <%s>.\n", INI_FILENAME);
	fprintf(stderr, "1. Check or modify the value <DicDirPath> in <%s>.\n", INI_FILENAME);
	fprintf(stderr, "2. Check or modify <src/kma.c> --> function open_HAM() --> argument <%s>\n", INI_FILENAME);
}
